...
class InferencePipeline:
    def __init__(self, dataset_path, groq_api_key):
        ...
        self.examples = {
            ...
            'Home Appliances': {
                'Small Domestic Appliances': ['Blender', 'Toaster', 'Coffee Maker', 'Microwave', 'Electric Kettle'],
                'Major Domestic Appliances': ['Refrigerator', 'Washing Machine', 'Dishwasher', 'Oven', 'Dryer']
            },
            'Clothing': {
    ...
    def _process_groq(self, batch, model_name):
        ...
        for item in batch:
            try:
                ...
                prompt = f"""Classify product: {item['item_name']}
...
if __name__ == '__main__':
    ...
    config = {
        'dataset_path': '/content/single_file_200_samples.csv',
        'groq_api_key': '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',
        'models_to_test': [
            'gemma2-9b-it'
        ],
        'output_dir': '/content/results/new_gemma_noprice'
    }
