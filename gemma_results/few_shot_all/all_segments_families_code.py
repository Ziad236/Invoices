#!pip install transformers pandas scikit-learn groq


############Results############
 # The results are on the entire dataset (English + Arabic)
# Performance Results: {       
#   "gemma2-9b-it": {
#     "accuracy_segment": 0.9363636363636364,
#     "f1_segment": 0.9363636363636364,
#     "accuracy_family": 0.6727272727272727,
#     "f1_family": 0.6727272727272727,
#     "avg_inference_time": 2.472811326113614
#   }
# }

# The results are on the English dataset
# Performance Results: {
#   "gemma2-9b-it": {
#     "accuracy_segment": 0.9224137931034483,
#     "f1_segment": 0.9224137931034483,
#     "accuracy_family": 0.7155172413793104,
#     "f1_family": 0.7155172413793104,
#     "avg_inference_time": 2.474892387787501
#   }
# }

# The results are on the Arabic dataset
# Performance Results: {
#   "gemma2-9b-it": {
#     "accuracy_segment": 0.9519230769230769,
#     "f1_segment": 0.9519230769230769,
#     "accuracy_family": 0.6634615384615384,
#     "f1_family": 0.6634615384615384,
#     "avg_inference_time": 2.4633618031229294
#   }
# }
...
class InferencePipeline:
    ...
    def process_batch(self, batch, model_name):
        """Send a batch of items to the Groq API for inference."""
        responses = []
        ...
        for item in batch:
            try:
                response = self.groq_client.chat.completions.create(
                    messages=[{
                        "role": "user",
                        "content": f"""Classify product: {item['item_name']}
                ...
                responses.append({
                    ...
                    "segment_code": self.segment_mapping.get(response_data.get('segment_name', ''), ''),
                    "segment_name": response_data.get('segment_name', ''),
                    "family_code": self.family_mapping.get(response_data.get('family_name', ''), ''),
...
if __name__ == '__main__':
    config = {
        'dataset_path': '/content/concat_file.csv',
        'groq_api_key': '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',
        'models_to_test': [
            'gemma2-9b-it'
        ],
        'output_dir': './results'
